# Creates low resolution images of images
# from a dataset. Input images from training
# and validation folders are downsampled and
# saved in the corresponding low resolution folders
