...
from manogna_sreenivas.AllFunctions import decimate, image_deblur, image_denoise, \
    wiener_filter, inverse_filter, cls_filter, bilateral_filter, edge_detect
...
def problem2():
    ...
    bilateral_filt = bilateral_filter(noisybook2,
                                      param=[3, 0.3, 7])  # param = [sigma_gaussian, signma_intensity_diff, kernel_size]
